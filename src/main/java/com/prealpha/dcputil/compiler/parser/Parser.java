...
public class Parser {
    ...
    public static final Pattern operation              = Pattern.compile("((SET)|(ADD)|(SUB)|(MUL)|(MLI)|(DIV)|(DVI)|" +
    ...
    public static final Pattern stackOperations         = Pattern.compile("^((PUSH)|(POP)|(PEEK))$",Pattern.CASE_INSENSITIVE);
